...
<div class="container">
    ...
    <div class="header">
        <div>
            <div class="title">{{ __('txn.delivery_notes_title') }}</div>
    ...
    <div class="meta"><strong>{{ __('txn.recipient') }}:</strong> {{ $note->recipient_name }}</div>
    <div class="meta"><strong>{{ __('txn.phone') }}:</strong> {{ $note->recipient_phone ?: '-' }}</div>
    <div class="meta"><strong>{{ __('txn.city') }}:</strong> {{ $note->city ?: '-' }}</div>
    <div class="meta"><strong>{{ __('txn.address') }}:</strong> {{ $note->address ?: '-' }}</div>
