{{-- Shared SPK form fields (used by the create page and the edit modal). --}}
<p class="pk-muted" style="font-size:12px; margin:0 0 12px;">No. SPK dibuat otomatis (urut/SPK/bulan-romawi/tahun, reset tiap semester).</p>
...
<div style="display:grid; grid-template-columns:repeat(3,1fr); gap:10px;">
    ...
    <div style="grid-column:1/4;"><label>Catatan</label><textarea name="catatan" rows="2" style="width:100%;"></textarea></div>
</div>
<datalist id="pk-mesin-cover"><option value="Lithrone"></option><option value="Komori 66"></option></datalist>

<h3 style="font-size:12px; text-transform:uppercase; color:var(--muted); margin:16px 0 8px;">Bahan Baku (minimal satu)</h3>
<div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
    <div class="pk-panel" data-bahan="web">
        <label style="display:flex; align-items:center; gap:8px; font-weight:600; color:var(--text);"><input type="checkbox" name="pakai_web" value="1" class="pk-toggle-web" checked> Web (Cetak Isi)</label>
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px; margin-top:8px;">
            <input type="text" name="web_kertas" placeholder="Kertas"><input type="text" name="web_warna" placeholder="Warna">
            <input type="text" name="web_mesin" placeholder="Mesin"><input type="text" name="web_waste" placeholder="Waste">
        </div>
    </div>
    <div class="pk-panel" data-bahan="sheet">
        <label style="display:flex; align-items:center; gap:8px; font-weight:600; color:var(--text);"><input type="checkbox" name="pakai_sheet" value="1" class="pk-toggle-sheet" checked> Sheet (Cetak Cover)</label>
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px; margin-top:8px;">
            <input type="text" name="sheet_kertas" placeholder="Kertas"><input type="text" name="sheet_warna" placeholder="Warna">
            <input type="text" name="sheet_mesin" placeholder="Mesin"><input type="text" name="sheet_waste" placeholder="Waste">
        </div>
    </div>
</div>

<h3 style="font-size:12px; text-transform:uppercase; color:var(--muted); margin:16px 0 8px;">Jenis Cetak</h3>
...
<h3 style="font-size:12px; text-transform:uppercase; color:var(--muted); margin:16px 0 8px;">Rincian Barang</h3>
...
<h3 style="font-size:12px; text-transform:uppercase; color:var(--muted); margin:16px 0 8px;">Penanggung Jawab</h3>
...
<template id="pk-item-tpl">
    <tr class="pk-item-row">
        ...
        <td style="position:relative;">
            ...
            <div class="pk-prod-results" style="display:none; position:absolute; z-index:20; left:0; right:0; background:var(--card); border:1px solid var(--border); border-radius:6px; max-height:180px; overflow:auto;"></div>
        </td>
