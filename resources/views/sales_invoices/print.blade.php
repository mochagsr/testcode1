...
<head>
    ...
    <style>
        ...
        .doc-title-center { font-size: 12px; line-height: 1.3; min-width: 180px; text-align: center; align-self: center; justify-self: start; min-width: 0; font-weight: 700; margin-left: -48px; }
        ...
        .total-box { width: 100%; border-collapse: collapse; table-layout: fixed; }
