...
<div class="container">
    ...
    <div class="company-head">
        ...
        <div class="doc-meta-right">
            <div class="doc-title">{{ __('txn.sales_returns_title') }}</div>
    ...
    <div style="margin-top: 10px;"><strong>{{ __('txn.total_return') }}:</strong> Rp {{ number_format((int) round($salesReturn->total), 0, ',', '.') }}</div>
