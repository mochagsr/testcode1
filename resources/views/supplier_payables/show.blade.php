...
@section('title', $payment->payment_number.' - '.config('app.name', 'Laravel'))
            ...
            <form method="post" action="{{ route('supplier-payables.admin-update', $payment) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" inputmode="numeric" class="js-thousand-input" name="amount" value="{{ old('amount', (int) $payment->amount) }}" placeholder="0" required>
                    </div>
                    <div class="col-4">
