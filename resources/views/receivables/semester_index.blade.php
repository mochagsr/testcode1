...
@section('title', __('receivable.semester_page_title').' - '.config('app.name', 'Laravel'))
    ...
    <div class="card">
        <form method="get" class="receivable-semester-toolbar">
            ...
            <div class="toolbar-right">
                ...
                <x-export-menu
                    :options="[
                        ['label' => 'Export Excel', 'url' => route('receivables.semester.export.excel', request()->query())],
                        ['label' => 'Export PDF', 'url' => route('receivables.semester.export.pdf', request()->query())],
                    ]"
                />
            </div>
        </form>
