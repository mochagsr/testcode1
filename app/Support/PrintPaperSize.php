...
final class PrintPaperSize
{
    ...
    public const CONTINUOUS_FORM_95X55_WIDTH_POINTS = 684;

    public const CONTINUOUS_FORM_95X55_HEIGHT_POINTS = 396;
    ...
    /**
     * DomPDF custom paper size for receipt continuous form 9.5" x 5.5".
     *
     * @return array{0:int,1:int,2:int,3:int}
     */
    public static function continuousForm95x55(): array
    {
        return [
            0,
            0,
            self::CONTINUOUS_FORM_95X55_WIDTH_POINTS,
            self::CONTINUOUS_FORM_95X55_HEIGHT_POINTS,
        ];
    }
}
